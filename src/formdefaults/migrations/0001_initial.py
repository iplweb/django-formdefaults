...
# Modernised in 0.1.0: dropped the django.contrib.postgres.fields.jsonb
# import (removed in Django 5.x). Schema is identical: PostgreSQL still
# gets a jsonb column. The follow-up migration 0002 also uses
# models.JSONField, so this is just a no-op cleanup of an alias.
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.JSONField(blank=True, null=True, verbose_name="Wartość"),
                ),
                (
                    "field",
                    models.ForeignKey(
